...
function initCCP() {
	...
	connect.agentApp.initApp("customerprofiless", "customerprofiles-container", connectUrl + "/customerprofiles-v2/", {
		...
		<React.Fragment>
			<div className="container-fluid">
				<div id="tools" className="row">
					{/* <SoftPhone height={"90vh"} layout='TemplateOne' /> */}
					...
					<div id="helper-container" className="col-6 col-md-6 p-0" style={{ height: "90vh" }}>
						<ul className="nav nav-tabs nav-fill" data-bs-tabs="tabs">
							<li className="nav-item" id="tab_customer_profiles">
								<a className="nav-link active" aria-current="true" data-bs-toggle="tab" href="#customerprofiles-container">
									Customer Profiles
								</a>
							</li>
							<li className="nav-item">
								<a className="nav-link" data-bs-toggle="tab" href="#wisdom-container">
									Wisdom
								</a>
							</li>
						</ul>
						<div className="tab-content container-fluid">
							<div className="tab-pane active" id="customerprofiles-container"></div>
							<div className="tab-pane" id="wisdom-container"></div>
						</div>
					</div>
